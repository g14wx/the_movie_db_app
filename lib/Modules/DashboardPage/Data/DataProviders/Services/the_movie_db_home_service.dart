...
class TheMovieDbHomeService implements ITheMovieDbHomeService{
  ...
  @override
  Future<Either<Exception, List<Movie>>> getAllMovies({required String apiKey}) async {
  ...
  @override
  Future<Either<Exception, List<Movie>>> getSearchMovie({required String query, required String apiKey}) async {
